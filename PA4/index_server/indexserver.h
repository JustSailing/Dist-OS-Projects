...
struct PeerNode
{
    ...
    std::vector<std::pair<std::string, std::string>> files_map;
};
...
private:
    ...
    */
    [[nodiscard]] int RegisterNode(Message &message, int peer_sock, std::string_view ip) noexcept;
    ...
    */
    ...
    void Register(Message &message, int peer_sock, std::string_view ip,
                  const std::chrono::system_clock::time_point &start) noexcept;
